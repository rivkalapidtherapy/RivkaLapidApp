// Neon.tech Serverless SQL Adapter for RivkaLapid
import { neon } from '@neondatabase/serverless';

const databaseUrl =
  (import.meta as any).env?.VITE_NEON_DATABASE_URL ||
  (import.meta as any).env?.DATABASE_URL ||
  'postgresql://neondb_owner:npg_eDw4jEvsIkN0@ep-delicate-morning-b2anrz41-pooler.c-6.eu-central-1.aws.neon.tech/neondb?sslmode=require';
