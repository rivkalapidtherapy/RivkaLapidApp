...
import { getAvailabilityForDate, addAppointment, sendWhatsAppMessage, getConfirmationMessage } from '../services/bookingService';
          ...
          <div className="space-y-4">
            {SERVICES.map(service => (
              <div 
                ...
                className={`p-6 rounded-2xl border transition-all cursor-pointer text-right group ${
